-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('DEFAULT', 'EVENT', 'ARTICLE');
...
-- AddForeignKey
ALTER TABLE "posts_comments" ADD CONSTRAINT "posts_comments_comment_id_fkey" FOREIGN KEY ("comment_id") REFERENCES "comments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
